...
ActiveRecord::Schema.define(version: 20130628224221) do
  ...
  add_index "boards_managers", ["board_id"], name: "index_boards_managers_on_board_id", using: :btree
  add_index "boards_managers", ["manager_id"], name: "index_boards_managers_on_manager_id", using: :btree
  ...
  add_index "categories_user_groups", ["category_id"], name: "index_categories_user_groups_on_category_id", using: :btree
  add_index "categories_user_groups", ["user_group_id"], name: "index_categories_user_groups_on_user_group_id", using: :btree
  ...
  add_index "forums_boards", ["category_id"], name: "index_forums_boards_on_category_id", using: :btree
  add_index "forums_boards", ["slug"], name: "index_forums_boards_on_slug", unique: true, using: :btree
  ...
  add_index "forums_categories", ["slug"], name: "index_forums_categories_on_slug", unique: true, using: :btree
  ...
  add_index "forums_posts", ["reply_to_id"], name: "index_forums_posts_on_reply_to_id", using: :btree
  add_index "forums_posts", ["topic_id"], name: "index_forums_posts_on_topic_id", using: :btree
  add_index "forums_posts", ["user_id"], name: "index_forums_posts_on_user_id", using: :btree
  ...
  add_index "forums_topics", ["board_id"], name: "index_forums_topics_on_board_id", using: :btree
  add_index "forums_topics", ["slug"], name: "index_forums_topics_on_slug", unique: true, using: :btree
  add_index "forums_topics", ["user_id"], name: "index_forums_topics_on_user_id", using: :btree
  ...
  add_index "forums_views", ["user_id"], name: "index_forums_views_on_user_id", using: :btree
  add_index "forums_views", ["viewable_id"], name: "index_forums_views_on_viewable_id", using: :btree
  ...
  add_index "news_entries", ["slug"], name: "index_news_entries_on_slug", unique: true, using: :btree
  ...
  add_index "permissions", ["identifier"], name: "index_permissions_on_identifier", using: :btree
  ...
  add_index "shoutbox_messages", ["user_id"], name: "index_shoutbox_messages_on_user_id", using: :btree
  ...
  add_index "system_settings", ["identifier"], name: "index_system_settings_on_identifier", unique: true, using: :btree
